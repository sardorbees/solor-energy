...
const SolarPanelList = () => {
    ...
    const fetchPowers = async () => {
        try {
            const res = await axios.get("http://127.0.0.1:8000/api/andeli/power/");
            setPowers(res.data);
        } catch (error) {
...
function Andeli() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`http://127.0.0.1:8000/api/andeli/products/?${query}`);
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-header-box">
                                <br /><br />
                                <h1 className="text-anime">Andeli бранд</h1>
