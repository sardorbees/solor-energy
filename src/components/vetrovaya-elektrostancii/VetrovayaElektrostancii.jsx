...
const SolarPanelList = () => {
    ...
    const fetchPowers = async () => {
        try {
            const res = await axios.get("http://127.0.0.1:8000/api/vetrovaya_elektrostancii/power/");
            setPowers(res.data);
        } catch (error) {
...
function VetrovayaElektrostancii() {
    const navigate = useNavigate();
    const location = useLocation();
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`http://127.0.0.1:8000/api/vetrovaya_elektrostancii/products/?${query}`);
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-header-box">
                                <br /><br />
                                <h1 className="text-anime">ВЕТРОВАЯ ЭЛЕКТРОСТАНЦИИ</h1>
...
export default VetrovayaElektrostancii;
