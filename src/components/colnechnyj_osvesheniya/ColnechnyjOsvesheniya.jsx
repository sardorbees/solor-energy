...
const SolarPanelList = () => {
    ...
    const fetchPowers = async () => {
        try {
            const res = await axios.get("http://127.0.0.1:8000/api/colnechnyj_osvesheniya/power/");
            setPowers(res.data);
        } catch (error) {
...
function ColnechnyjOsvesheniya() {
    const navigate = useNavigate();
    const location = useLocation();
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`http://127.0.0.1:8000/api/colnechnyj_osvesheniya/products/?${query}`);
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-header-box">
                                <br /><br />
                                <h1 className="text-anime">CОЛНЕЧНЫЙ ОСВЕЩЕНИЯ</h1>
...
export default ColnechnyjOsvesheniya;
