...
const SolarPanelList = () => {
    ...
    const fetchPowers = async () => {
        try {
            const res = await axios.get("http://127.0.0.1:8000/api/individualnyj_teplovoj_punkt/power/");
            setPowers(res.data);
        } catch (error) {
...
function IndividualnyjTeplovojPunkt() {
    const navigate = useNavigate();
    const location = useLocation();
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await axios.get(`http://127.0.0.1:8000/api/individualnyj_teplovoj_punkt/products/?${query}`);
                    ...
                    <div className="row">
                        <div className="col-md-12">
                            <div className="page-header-box">
                                <br /><br />
                                <h1 className="text-anime">ИНДИВИДУАЛЬНЫЙ ТЕПЛОВОЙ ПУНКТ</h1>
...
export default IndividualnyjTeplovojPunkt;
